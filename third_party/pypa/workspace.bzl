# DO NOT EDIT: Generated by generate_workspace.bzl
...
def repo_pypa_apache_beam():
    ...
    maybe(
        ...
        target = "apache_beam",
        requirement = "apache-beam==2.32.0",
        deps = [
...
def repo_pypa_importlib_metadata():
    ...
    maybe(
        ...
        requirement = "importlib-metadata==4.8.1",
        deps = [
            "@pypa_typing_extensions//:typing_extensions",
            "@pypa_zipp//:zipp",
        ],
...
def repo_pypa_typing_extensions():
    maybe(
        ...
        requirement = "typing-extensions==3.10.0.2",
    )
