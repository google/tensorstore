...
def repo_pypa_apache_beam():
    ...
    maybe(
        ...
        target = "apache_beam",
        requirement = "apache-beam==2.31.0",
        deps = [
...
def repo_pypa_charset_normalizer():
    maybe(
        ...
        requirement = "charset-normalizer==2.0.4",
    )
...
def repo_pypa_importlib_metadata():
    ...
    maybe(
        ...
        requirement = "importlib-metadata==4.6.3",
        deps = [
            "@pypa_typing_extensions//:typing_extensions",
            "@pypa_zipp//:zipp",
        ],
...
def repo_pypa_pytest_asyncio():
    ...
    maybe(
        ...
        requirement = "pytest-asyncio==0.15.1",
        deps = [
            "@pypa_pytest//:pytest",
        ],
    )
...
def repo_pypa_snowballstemmer():
    maybe(
        ...
        requirement = "snowballstemmer==2.1.0",
    )
...
def repo_pypa_typing_extensions():
    maybe(
        ...
        requirement = "typing-extensions==3.10.0.0",
    )
