...
void aom_get_sse_sum_8x8_quad_avx2(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse, int *sum);
RTCD_EXTERN void (*aom_get_sse_sum_8x8_quad)(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse, int *sum);
...
static void setup_rtcd_internal(void)
{
    ...
    if (flags & HAS_AVX2) aom_get_sse_sum_8x8_quad = aom_get_sse_sum_8x8_quad_avx2;
