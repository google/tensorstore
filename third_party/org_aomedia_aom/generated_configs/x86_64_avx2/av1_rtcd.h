...
#define av1_apply_temporal_filter av1_apply_temporal_filter_avx2
...
#define av1_block_error_lp av1_block_error_lp_avx2
...
#define av1_calc_indices_dim1 av1_calc_indices_dim1_avx2
...
#define av1_calc_indices_dim2 av1_calc_indices_dim2_avx2
...
#define av1_cnn_convolve_no_maxpool_padding_valid av1_cnn_convolve_no_maxpool_padding_valid_avx2
...
#define av1_convolve_2d_sr av1_convolve_2d_sr_avx2
...
#define av1_convolve_x_sr av1_convolve_x_sr_avx2
...
#define av1_convolve_y_sr av1_convolve_y_sr_avx2
...
#define av1_dist_wtd_convolve_2d_copy av1_dist_wtd_convolve_2d_copy_avx2
...
#define av1_dist_wtd_convolve_x av1_dist_wtd_convolve_x_avx2
...
#define av1_dist_wtd_convolve_y av1_dist_wtd_convolve_y_avx2
...
#define av1_estimate_noise_from_single_plane av1_estimate_noise_from_single_plane_avx2
...
#define av1_highbd_apply_temporal_filter av1_highbd_apply_temporal_filter_avx2
...
#define av1_highbd_block_error av1_highbd_block_error_avx2
...
#define av1_highbd_dr_prediction_z1 av1_highbd_dr_prediction_z1_avx2
...
#define av1_highbd_dr_prediction_z2 av1_highbd_dr_prediction_z2_avx2
...
#define av1_highbd_dr_prediction_z3 av1_highbd_dr_prediction_z3_avx2
...
#define av1_nn_predict av1_nn_predict_avx2
...
#define av1_quantize_fp av1_quantize_fp_avx2

void av1_quantize_fp_32x32_c(const tran_low_t *coeff_ptr, intptr_t n_coeffs, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, tran_low_t *qcoeff_ptr, tran_low_t *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan);
void av1_quantize_fp_32x32_avx2(const tran_low_t *coeff_ptr, intptr_t n_coeffs, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, tran_low_t *qcoeff_ptr, tran_low_t *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan);
#define av1_quantize_fp_32x32 av1_quantize_fp_32x32_avx2

void av1_quantize_fp_64x64_c(const tran_low_t *coeff_ptr, intptr_t n_coeffs, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, tran_low_t *qcoeff_ptr, tran_low_t *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan);
void av1_quantize_fp_64x64_avx2(const tran_low_t *coeff_ptr, intptr_t n_coeffs, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, tran_low_t *qcoeff_ptr, tran_low_t *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan);
#define av1_quantize_fp_64x64 av1_quantize_fp_64x64_avx2
...
#define av1_quantize_lp av1_quantize_lp_avx2
...
#define av1_resize_horz_dir av1_resize_horz_dir_avx2
...
#define av1_resize_vert_dir av1_resize_vert_dir_avx2
...
#define av1_wedge_compute_delta_squares av1_wedge_compute_delta_squares_avx2
...
#define av1_wedge_sign_from_residuals av1_wedge_sign_from_residuals_avx2
...
#define av1_wedge_sse_from_residuals av1_wedge_sse_from_residuals_avx2
...
#define av1_wiener_convolve_add_src av1_wiener_convolve_add_src_avx2
...
#define cfl_get_subtract_average_fn cfl_get_subtract_average_fn_avx2
...
static void setup_rtcd_internal(void)
{
    ...
    av1_highbd_dist_wtd_convolve_2d_copy = av1_highbd_dist_wtd_convolve_2d_copy_avx2;
    ...
    av1_highbd_wiener_convolve_add_src = av1_highbd_wiener_convolve_add_src_avx2;
