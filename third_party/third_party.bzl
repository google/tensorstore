...
load("//third_party:com_github_aws_c_auth/workspace.bzl", repo_com_github_aws_c_auth = "repo")
load("//third_party:com_github_aws_c_cal/workspace.bzl", repo_com_github_aws_c_cal = "repo")
load("//third_party:com_github_aws_c_common/workspace.bzl", repo_com_github_aws_c_common = "repo")
load("//third_party:com_github_aws_c_compression/workspace.bzl", repo_com_github_aws_c_compression = "repo")
load("//third_party:com_github_aws_c_event_stream/workspace.bzl", repo_com_github_aws_c_event_stream = "repo")
load("//third_party:com_github_aws_c_http/workspace.bzl", repo_com_github_aws_c_http = "repo")
load("//third_party:com_github_aws_c_io/workspace.bzl", repo_com_github_aws_c_io = "repo")
load("//third_party:com_github_aws_c_iot/workspace.bzl", repo_com_github_aws_c_iot = "repo")
load("//third_party:com_github_aws_c_mqtt/workspace.bzl", repo_com_github_aws_c_mqtt = "repo")
load("//third_party:com_github_aws_c_s3/workspace.bzl", repo_com_github_aws_c_s3 = "repo")
load("//third_party:com_github_aws_c_sdkutils/workspace.bzl", repo_com_github_aws_c_sdkutils = "repo")
load("//third_party:com_github_aws_checksums/workspace.bzl", repo_com_github_aws_checksums = "repo")
load("//third_party:com_github_aws_cpp_crt/workspace.bzl", repo_com_github_aws_cpp_crt = "repo")
load("//third_party:com_github_aws_cpp_sdk/workspace.bzl", repo_com_github_aws_cpp_sdk = "repo")
...
load("//third_party:com_github_s2n_tls/workspace.bzl", repo_com_github_s2n_tls = "repo")
...
def third_party_dependencies():
    ...
    repo_bazel_skylib()
    repo_blake3()
    repo_com_github_aws_c_auth()
    repo_com_github_aws_c_cal()
    repo_com_github_aws_c_common()
    repo_com_github_aws_c_compression()
    repo_com_github_aws_c_event_stream()
    repo_com_github_aws_c_http()
    repo_com_github_aws_c_io()
    repo_com_github_aws_c_iot()
    repo_com_github_aws_c_mqtt()
    repo_com_github_aws_c_s3()
    repo_com_github_aws_c_sdkutils()
    repo_com_github_aws_checksums()
    repo_com_github_aws_cpp_crt()
    repo_com_github_aws_cpp_sdk()
