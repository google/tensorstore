...
#ifndef TENSORSTORE_DRIVER_OMETIFF_COMPRESSOR_REGISTRY_H_
#define TENSORSTORE_DRIVER_OMETIFF_COMPRESSOR_REGISTRY_H_
...
#endif  // TENSORSTORE_DRIVER_OMETIFF_COMPRESSOR_REGISTRY_H_
