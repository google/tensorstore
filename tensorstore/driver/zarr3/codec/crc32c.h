...
#ifndef TENSORSTORE_DRIVER_ZARR3_CODEC_CRC32C_H_
#define TENSORSTORE_DRIVER_ZARR3_CODEC_CRC32C_H_
...
class Crc32cCodecSpec : public ZarrBytesToBytesCodecSpec {
 public:
  Crc32cCodecSpec() = default;
...
#endif  // TENSORSTORE_DRIVER_ZARR3_CODEC_CRC32C_H_
