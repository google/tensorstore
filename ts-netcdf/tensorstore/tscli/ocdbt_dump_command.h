...
#ifndef TENSORSTORE_TSCLI_OCDBT_DUMP_COMMAND_H_
#define TENSORSTORE_TSCLI_OCDBT_DUMP_COMMAND_H_
...
class OcdbtDumpCommand : public Command {
 public:
  OcdbtDumpCommand();
...
#endif  // TENSORSTORE_TSCLI_OCDBT_DUMP_COMMAND_H_
