...
add_custom_command(
  OUTPUT "${TEST_BINDIR}/_nasm/asm_library/e3a1b44e/a.asm.o"
  ...
  COMMAND ${CMAKE_ASM_NASM_COMPILER}
          ...
          -o "${TEST_BINDIR}/_nasm/asm_library/e3a1b44e/a.asm.o"
          "${TEST_SRCDIR}/a.asm"
  COMMENT "Assembling NASM source ${TEST_SRCDIR}/a.asm"
)
set_source_files_properties("${TEST_BINDIR}/_nasm/asm_library/e3a1b44e/a.asm.o"
...
target_sources(CMakeProject_a PRIVATE
        "${PROJECT_BINARY_DIR}/_nasm/asm_library/e3a1b44e/a.asm.o"
