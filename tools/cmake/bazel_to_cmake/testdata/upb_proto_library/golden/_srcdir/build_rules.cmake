...
add_custom_target(genrule_CMakeProject_aspect_cpp__9411025a DEPENDS
    "${PROJECT_BINARY_DIR}/_gen_cpp/a.pb.h"
    "${PROJECT_BINARY_DIR}/_gen_cpp/a.pb.cc")
add_library(CMakeProject_aspect_cpp__9411025a INTERFACE)
target_sources(CMakeProject_aspect_cpp__9411025a INTERFACE
    "${TEST_BINDIR}/_gen_cpp/a.pb.cc"
    "${TEST_BINDIR}/_gen_cpp/a.pb.h")
target_include_directories(CMakeProject_aspect_cpp__9411025a INTERFACE
    "${PROJECT_BINARY_DIR}/_gen_cpp")
add_dependencies(CMakeProject_aspect_cpp__9411025a genrule__CMakeProject_aspect_cpp__9411025a)
...
add_custom_target(genrule_CMakeProject_aspect_upb_minitable__9411025a DEPENDS
    "${PROJECT_BINARY_DIR}/_gen_upb_minitable/a.upb_minitable.h"
    "${PROJECT_BINARY_DIR}/_gen_upb_minitable/a.upb_minitable.c")
add_library(CMakeProject_aspect_upb_minitable__9411025a INTERFACE)
target_sources(CMakeProject_aspect_upb_minitable__9411025a INTERFACE
    "${TEST_BINDIR}/_gen_upb_minitable/a.upb_minitable.c"
    "${TEST_BINDIR}/_gen_upb_minitable/a.upb_minitable.h")
target_include_directories(CMakeProject_aspect_upb_minitable__9411025a INTERFACE
    "${PROJECT_BINARY_DIR}/_gen_upb_minitable")
add_dependencies(CMakeProject_aspect_upb_minitable__9411025a genrule__CMakeProject_aspect_upb_minitable__9411025a)
...
add_custom_target(genrule_CMakeProject_aspect_upb__9411025a DEPENDS
    "${PROJECT_BINARY_DIR}/_gen_upb/a.upb.h"
    "${PROJECT_BINARY_DIR}/_gen_upb/a.upb.c")
add_library(CMakeProject_aspect_upb__9411025a INTERFACE)
target_sources(CMakeProject_aspect_upb__9411025a INTERFACE
    "${TEST_BINDIR}/_gen_upb/a.upb.c"
    "${TEST_BINDIR}/_gen_upb/a.upb.h")
target_include_directories(CMakeProject_aspect_upb__9411025a INTERFACE
    "${PROJECT_BINARY_DIR}/_gen_upb")
add_dependencies(CMakeProject_aspect_upb__9411025a genrule__CMakeProject_aspect_upb__9411025a)
...
add_custom_target(genrule_CMakeProject_aspect_upbdefs__9411025a DEPENDS
    "${PROJECT_BINARY_DIR}/_gen_upbdefs/a.upbdefs.h"
    "${PROJECT_BINARY_DIR}/_gen_upbdefs/a.upbdefs.c")
add_library(CMakeProject_aspect_upbdefs__9411025a INTERFACE)
target_sources(CMakeProject_aspect_upbdefs__9411025a INTERFACE
    "${TEST_BINDIR}/_gen_upbdefs/a.upbdefs.c"
    "${TEST_BINDIR}/_gen_upbdefs/a.upbdefs.h")
target_include_directories(CMakeProject_aspect_upbdefs__9411025a INTERFACE
    "${PROJECT_BINARY_DIR}/_gen_upbdefs")
add_dependencies(CMakeProject_aspect_upbdefs__9411025a genrule__CMakeProject_aspect_upbdefs__9411025a)
