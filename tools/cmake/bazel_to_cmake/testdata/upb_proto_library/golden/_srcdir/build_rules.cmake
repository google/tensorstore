...
file(GENERATE
OUTPUT
    "${PROJECT_BINARY_DIR}/_gen_cpp/_protoc_inc_e6c584da.txt"
CONTENT
...
file(GENERATE
OUTPUT
    "${PROJECT_BINARY_DIR}/_gen_upb/_protoc_inc_cab4be07.txt"
CONTENT
    "$<$<BOOL:$<TARGET_PROPERTY:CMakeProject_a_proto,INTERFACE_INCLUDE_DIRECTORIES>>:-I$<JOIN:$<TARGET_PROPERTY:CMakeProject_a_proto,INTERFACE_INCLUDE_DIRECTORIES>,
-I>>"
)
...
file(GENERATE
OUTPUT
    "${PROJECT_BINARY_DIR}/_gen_upb_minitable/_protoc_inc_9d2966e0.txt"
CONTENT
    "$<$<BOOL:$<TARGET_PROPERTY:CMakeProject_a_proto,INTERFACE_INCLUDE_DIRECTORIES>>:-I$<JOIN:$<TARGET_PROPERTY:CMakeProject_a_proto,INTERFACE_INCLUDE_DIRECTORIES>,
-I>>"
)
...
file(GENERATE
OUTPUT
    "${PROJECT_BINARY_DIR}/_gen_upbdefs/_protoc_inc_1289b9d6.txt"
CONTENT
    "$<$<BOOL:$<TARGET_PROPERTY:CMakeProject_a_proto,INTERFACE_INCLUDE_DIRECTORIES>>:-I$<JOIN:$<TARGET_PROPERTY:CMakeProject_a_proto,INTERFACE_INCLUDE_DIRECTORIES>,
-I>>"
)
