...
// https://github.com/jax-ml/ml_dtypes/blob/main/ml_dtypes/_src/common.h
...
template <>
struct TypeDescriptor<half_float::half> {
...
#endif  // THIRD_PARTY_PY_TENSORSTORE_CUSTOM_NUMPY_DTYPES_H_
