...
#ifndef THIRD_PARTY_PY_TENSORSTORE_CUSTOM_FLOAT_H_
#define THIRD_PARTY_PY_TENSORSTORE_CUSTOM_FLOAT_H_
...
// https://github.com/jax-ml/ml_dtypes/blob/main/ml_dtypes/_src/custom_float.h
...
#undef copysign  // temporary fix for Windows bazel build
...
bool RegisterFloatCasts() {
  if (!RegisterCustomFloatCast<T, half_float::half>(NPY_HALF)) {
    return false;
  }
...
#endif  // THIRD_PARTY_PY_TENSORSTORE_CUSTOM_FLOAT_H_
